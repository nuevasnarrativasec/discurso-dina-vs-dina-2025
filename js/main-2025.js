...
document.addEventListener("DOMContentLoaded", function() {
    function e(e, t) {
        ...
        o.addEventListener("click", function() {
            ...
            a.classList.toggle("expanded", !e), o.textContent = e ? "Ver más" : "Ver menos"
        })
    }
    ...
    let e = document.getElementById("siguiente-frase-destacada-ecdata-1"),
        t = document.getElementById("siguiente-frase-destacada-ecdata-1-movil"),
        a = document.querySelector(".box-main-desplegable-video-1-ecdata"),
        o = document.getElementById("text-container"),
        n = document.getElementById("text-container-movil"),
        l = document.getElementById("frase-destacada-ecdata-2"),
        s = document.getElementById("frase-destacada-ecdata-2-movil");
